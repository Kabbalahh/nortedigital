...
const PortfolioSystem = (() => {
    const projects = [
    { id: 1, title: 'Hamburgueria Criativa', category: 'ecommerce', client: 'Hamburgueria', image: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?auto=format&fit=crop&q=80&w=800', metrics: '+45% Vendas', tech: ['HTML3', 'Tailwind'], url: 'sites_portifolio/hamburgueria_criativa.html'},
    { id: 2, title: 'Helios Painéis solares', category: 'institucional', client: 'Helios', image: 'https://images.unsplash.com/photo-1724041875334-0a6397111c7e?q=80&w=387&auto=format&fit==crop&q=80&w=800', metrics: 'Load < 1.2s', tech: ['HTML', 'Tailwind'], url: 'sites_portifolio/helios.html' },
    { id: 3, title: 'Air Jordan Site Concept', category: 'landing', client: 'Nike', image: 'https://images.unsplash.com/photo-1608541737042-87a12275d313?q=80&w=861&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', metrics: 'concept', tech: ['HTML5', 'Tailwind'], url: 'sites_portifolio/air_jordan/index_jordan1.html' },
    { id: 4, title: 'Mecanica AutoTech', category: 'institucional', client: 'Autotech', image: 'https://images.unsplash.com/photo-1769147339214-076740872485?q=80&w=1031&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', metrics: 'Zero Downtime', tech: ['Vue.js', 'Python'], url: 'sites_portifolio/autotech_concept/index.html' },
    { id: 5, title: 'Novare', category: 'institucional', client: 'Novare SC', image: 'https://images.unsplash.com/photo-1691351582808-329cde17ffa2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXIlMjBjb25kaWNpb25hZG98ZW58MHx8MHx8fDA%3D0', metrics: 'Rebrading', tech: ['HTML', 'Tailwind'], url: 'sites_portifolio/novare_site_prototipo/index.html' },
    { id: 6, title: 'PIX AI', category: 'Aplicativo', client: 'PIX Brasil', image: 'https://images.unsplash.com/photo-1691351582808-329cde17ffa2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXIlMjBjb25kaWNpb25hZG98ZW58MHx8MHx8fDA%3D0', metrics: 'Rebrading', tech: ['HTML', 'CSS'], url: 'sites_portifolio/pixiasiteoficial/pixiaioficial.html' }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(missionBtn) {
        missionBtn.addEventListener('click', () => {
            ...
            const numeroWhatsApp = "5551937988445"; 
